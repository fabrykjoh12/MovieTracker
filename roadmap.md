...
- **Fictional data presented as real, remaining findings.** An earlier audit in this session flagged the Library calendar view for the same kind of seeded/demo content as the Home, Shell, Friends, and Profile findings above. It needs the same file-by-file confirmation pass applied here before fixing, rather than a blanket rewrite.
